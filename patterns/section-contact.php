 ...
 * Slug: citizim-2024/section-contact
 * Categories: section
 * keywords: section
 * Description: Section contact
 */
?>
<!-- wp:group {"metadata":{"name":"Section | Contact"},"align":"full","className":"is-style-section-style1","style":{"layout":{"rowSpan":1,"columnSpan":1},"spacing":{"padding":{"right":"var:preset|spacing|2","left":"var:preset|spacing|2","top":"var:preset|spacing|7","bottom":"var:preset|spacing|7"},"blockGap":"var:preset|spacing|5"}},"layout":{"type":"constrained","contentSize":"760px"}} -->
...
<h3 class="wp-block-heading has-text-align-center has-h-four-font-size" style="font-style:normal;font-weight:600">Plus d’informations ? Nous vous recontactons !</h3>
<!-- /wp:heading -->
